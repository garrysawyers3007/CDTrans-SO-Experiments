...
for layer_num in 1 2 11 12 
do
    for target in 'Art' 'Product' 'Real_World'
    do
    python train.py --config_file configs/pretrain.yml --layer_num $layer_num MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Clipart_2_'$target'_shuffled_cross_key_layer_'$layer_num \
