...
if __name__ == "__main__":
    ...
    if cfg.MODEL.UDA_STAGE == 'UDA':
        ...
        M1 = make_model(cfg, num_class=num_classes, camera_num=camera_num, view_num = view_num)
        M1.load_param_finetune(cfg.TEST.WEIGHT)
        M2 = make_model(cfg, num_class=num_classes, camera_num=camera_num, view_num = view_num)
        M2.load_param_finetune(args.imgnet_model_path)
        print("Per class acc")
