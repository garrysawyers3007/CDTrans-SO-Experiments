...
do
    ...
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Real_World_2'$target'_resnet50_clean' \
    ...
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Real_World_2'$target'_resnet50_clean_only_classifier' \
    DATASETS.ROOT_TRAIN_DIR '../data/OfficeHomeDataset/Real_World.txt' \
    DATASETS.ROOT_TEST_DIR '../data/OfficeHomeDataset/'$target'.txt'   \
    MODEL.Transformer_TYPE $model_type \
    MODEL.PRETRAIN_PATH '../data/pretrainModel/'$pretrain_model \
