...
for layer_num in 1
do
python train.py --config_file configs/pretrain.yml --patch_size $patch_size --layer_num $layer_num MODEL.DEVICE_ID "('2')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Real_World_2_'$target'_shuffled_Cross_Domain_key_layer_'$layer_num \
