...
do
    ...
    python train.py --config_file configs/pretrain.yml --feature_mixup True --feature_model_path '' --layer_num 1 MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Clipart_2'$target'_augs' \
    DATASETS.ROOT_TRAIN_DIR './data/OfficeHomeDataset/Clipart.txt' \
