...
if __name__ == '__main__':
    ...
    parser.add_argument("--lin_prot_path", default=None, type=str)
    ...
    # rare_classes_dict = {
    #     'Art2Clipart': [20, 11, 36, 45, 29, 0, 4, 39, 24, 22],
    #     'Art2Product': [23, 33, 60, 42, 15, 31, 24, 11, 7, 4],
    #     'Art2Real_World': [42, 62, 23, 60, 7, 31, 24, 0, 17, 45],
    #     'Clipart2Art': [34, 18, 52, 59, 35, 24, 54, 17, 22, 48],
    #     'Clipart2Product': [64, 56, 17, 34, 13, 51, 59, 54, 23, 33],
    #     'Clipart2Real_World': [45, 34, 0, 35, 48, 10, 41, 52, 23, 63]
    # }
    ...
    if cfg.MODEL.UDA_STAGE == 'UDA':
        ...
        if args.feature_mixup == True:
            ...
            model_logit = make_model(cfg, num_class=num_classes, camera_num=camera_num, view_num = view_num)
            model_logit.load_param_finetune(args.lin_prot_path)
            ...
            do_train_pretrain_patch_augs(
                ...
                model_logit, rare_classes_dict[args.configuration])
        else:
