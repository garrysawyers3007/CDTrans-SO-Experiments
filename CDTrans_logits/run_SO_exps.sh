...
# bash scripts/pretrain/officehome_patch_aug/run_officehome_Ar.sh deit_base>logs/Ar_5_11_mixup_2.txt
bash scripts/pretrain/officehome_patch_aug/run_officehome_Cl.sh deit_base>logs/Cl_5_11_mixup_2.txt
