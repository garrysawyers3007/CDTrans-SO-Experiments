...
python train.py --config_file configs/pretrain.yml --preload_path '../logs/pretrain/deit_base/office-home/APR_aug/transformer_best_model.pth' MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/APR_aug_preload' \
