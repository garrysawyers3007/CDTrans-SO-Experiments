...
do
    ...
    python train.py --config_file configs/pretrain.yml --lin_prot_path '../logs/pretrain/deit_base/office-home/Art_2_'$target'_only_classifier/transformer_best_model.pth' --layer_num 11 --num_patch_wise 5 --configuration 'Art2'$target MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Art_2_'$target'_logits_0.1_11_5' \
    DATASETS.ROOT_TRAIN_DIR '../data/OfficeHomeDataset/Art.txt' \
    DATASETS.ROOT_TEST_DIR '../data/OfficeHomeDataset/'$target'.txt'   \
    MODEL.Transformer_TYPE $model_type \
    MODEL.PRETRAIN_PATH '../data/pretrainModel/'$pretrain_model \
