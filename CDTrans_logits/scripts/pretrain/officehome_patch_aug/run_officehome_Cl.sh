...
for target in 'Art' 'Product' 'Real_World' 
do
    for num_patch in 5
    do   
    python train.py --config_file configs/pretrain.yml --num_patch_wise $num_patch --layer_num 11 --feature_model_path '../logs/pretrain/deit_base/office-home/Clipart_2'$target'_augs/transformer_best_model.pth' --lin_prot_path '../logs/pretrain/deit_base/office-home/Clipart_2_'$target'_only_classifier/transformer_best_model.pth' --configuration 'Clipart2'$target MODEL.DEVICE_ID "('2')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Clipart_2'$target'_patch_aug'$num_patch'__11_feature_mixup_RCS' \
