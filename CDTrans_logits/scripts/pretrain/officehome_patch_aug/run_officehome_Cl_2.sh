...
do
    for num_patch in 30
    do   
    python train.py --config_file configs/pretrain.yml --num_patch_wise $num_patch --layer_num 11 --feature_model_path '../logs/pretrain/deit_base/office-home/Clipart_2Art_augs/transformer_best_model.pth' MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Clipart_2'$target'_patch_aug'$num_patch \
