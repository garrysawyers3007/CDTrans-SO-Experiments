...
python train.py --config_file configs/pretrain.yml --augs True MODEL.DEVICE_ID "('0')"  DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/ACR_aug' \
