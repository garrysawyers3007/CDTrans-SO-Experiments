...
do
python train.py --config_file configs/pretrain.yml --patch_size $patch_size --pretrain_path '../logs/pretrain/deit_base/office-home/Real_World_2_'$target'SO_Dom_Cls/transformer_best_model.pth' MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Real_World_2_'$target'SO_W_k' \
