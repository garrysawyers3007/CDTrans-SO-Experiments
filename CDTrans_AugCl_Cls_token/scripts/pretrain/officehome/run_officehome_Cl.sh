...
do
python train.py --config_file configs/pretrain.yml --augcl_path '../remote_logs/pretrain/deit_base/office-home/Clipart_AugCl_DRI/transformer_best_model.pth' MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../remote_logs/pretrain/'$model'/office-home/Clipart_2_'$target'_Key_AugCl_Cls_token' \
