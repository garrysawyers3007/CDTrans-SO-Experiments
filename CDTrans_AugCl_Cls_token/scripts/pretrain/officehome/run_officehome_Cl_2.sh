...
do
    ...
    do
    python train.py --config_file configs/pretrain.yml --patch_size $patch_size MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Clipart_2_'$target'_shuffled_all_key_'$patch_size \
