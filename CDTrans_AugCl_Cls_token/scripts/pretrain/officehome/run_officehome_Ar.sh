...
do
python train.py --config_file configs/pretrain.yml --augcl_path '../logs/pretrain/deit_base/office-home/Art_AugCl_DRI/transformer_best_model.pth' MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../remote_logs/pretrain/'$model'/office-home/Art_2_'$target'_Key_AugCl_Cls_token' \
