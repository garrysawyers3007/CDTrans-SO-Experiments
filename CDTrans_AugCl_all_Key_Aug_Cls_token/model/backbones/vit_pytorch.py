...
class TransReID(nn.Module):
    ...
    def forward_features(self, aug_x, x, camera_id, view_id, keys=None):
        B = x.shape[0]
        x = self.patch_embed(x)
    ...
    def forward(self, aug_x, x, cam_label=None, view_label=None, keys=None):
        x = self.forward_features(aug_x, x, cam_label, view_label, keys)
        return x
