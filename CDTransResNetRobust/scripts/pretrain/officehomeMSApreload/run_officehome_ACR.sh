...
python train.py --config_file configs/pretrain.yml --preload_path '../logs/pretrain/deit_base/office-home/ACR_aug/transformer_best_model.pth' MODEL.DEVICE_ID "('0')"  DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/ACR_aug_preload' \
DATASETS.ROOT_TRAIN_DIR './data/OfficeHomeDataset/ACR.txt' \
