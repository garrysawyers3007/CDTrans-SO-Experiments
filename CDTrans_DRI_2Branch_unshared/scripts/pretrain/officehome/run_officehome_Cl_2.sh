...
for patch_size in 1 2 3 
do
    for target in 'Art' 'Product' 'Real_World'
    do
    python train.py --config_file configs/pretrain.yml --patch_size $patch_size MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
    OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Clipart_2_'$target'_shuffled_aug_key_'$patch_size'_20_10' \
