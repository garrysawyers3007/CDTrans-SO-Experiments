...
for layer_num in 1 
do
python train.py --config_file configs/pretrain.yml --patch_size $patch_size --layer_num $layer_num --SO_path '../logs/pretrain/deit_base/office-home/Art_2'$target'/transformer_best_model.pth' --W_p_path '../logs/pretrain/deit_base/office-home/Art_2_'$target'SO_Dom_Cls/transformer_best_model.pth' MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Art_2_'$target'_DRI_2B_unshared' \
