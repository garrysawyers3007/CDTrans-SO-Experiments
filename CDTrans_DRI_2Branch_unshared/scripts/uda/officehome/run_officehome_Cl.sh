...
do
    python train.py --config_file configs/uda.yml --dom_weight $dom_weight --SO_path '../logs/pretrain/deit_base/office-home/Clipart_2'$target_dataset'/transformer_best_model.pth' --W_p_path '../logs/pretrain/deit_base/office-home/Clipart_2_'$target_dataset'SO_Dom_Cls/transformer_best_model.pth' MODEL.DEVICE_ID $gpus  \
    OUTPUT_DIR '../logs/uda/'$model'/office-home/Clipart2'$target_dataset'_DRI_2B_freeze_k_classifier' \
