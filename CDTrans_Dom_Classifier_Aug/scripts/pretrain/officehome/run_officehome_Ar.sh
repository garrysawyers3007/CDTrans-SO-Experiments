...
OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Art_temp' \
DATASETS.ROOT_TRAIN_DIR '../data/OfficeHomeDataset/Art_test.txt' \
DATASETS.ROOT_TEST_DIR '../data/OfficeHomeDataset/Real_World.txt'   \
MODEL.Transformer_TYPE $model_type \
MODEL.PRETRAIN_PATH '../data/pretrainModel/'$pretrain_model \

# python train.py --config_file configs/pretrain.yml --layer_num $layer_num --dom_cls True MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
# OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Art_2_Product_AugCl' \
...
# python train.py --config_file configs/pretrain.yml --layer_num $layer_num --dom_cls True MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
# OUTPUT_DIR '../logs/pretrain/'$model'/office-home/Art_2_Real_World_AugCl' \
# DATASETS.ROOT_TRAIN_DIR '../data/OfficeHomeDataset/Art.txt' \
# DATASETS.ROOT_TEST_DIR '../data/OfficeHomeDataset/Real_World.txt'   \
# MODEL.Transformer_TYPE $model_type \
# MODEL.PRETRAIN_PATH '../data/pretrainModel/'$pretrain_model \
