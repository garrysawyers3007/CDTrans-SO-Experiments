...
for layer_num in 2
do
python train.py --config_file configs/pretrain.yml --patch_size $patch_size --layer_num $layer_num MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../remote_logs/pretrain/'$model'/office-home/Clipart_2_'$target'_shuffled_Cross_Domain_key_layer_rand' \
