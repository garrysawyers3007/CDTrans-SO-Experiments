...
for layer_num in 7 8 9 10 11 12
do
python train.py --config_file configs/pretrain.yml --layer_num $layer_num MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../remote_logs/pretrain/'$model'/office-home/Clipart_2_Art_shuffled_CEL_layer_'$layer_num \
...
python train.py --config_file configs/pretrain.yml --layer_num $layer_num MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../remote_logs/pretrain/'$model'/office-home/Clipart_2_Product_shuffled_CEL_layer_'$layer_num \
DATASETS.ROOT_TRAIN_DIR '../data/OfficeHomeDataset/Clipart.txt' \
...
python train.py --config_file configs/pretrain.yml --layer_num $layer_num MODEL.DEVICE_ID "('3')" DATASETS.NAMES 'OfficeHome' \
OUTPUT_DIR '../remote_logs/pretrain/'$model'/office-home/Clipart_2_Real_World_shuffled_CEL_layer_'$layer_num \
DATASETS.ROOT_TRAIN_DIR '../data/OfficeHomeDataset/Clipart.txt' \
